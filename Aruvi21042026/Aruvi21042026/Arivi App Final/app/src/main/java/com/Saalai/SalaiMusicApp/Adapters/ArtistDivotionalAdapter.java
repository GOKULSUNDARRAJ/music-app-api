...
public class ArtistDivotionalAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ArtistDivotionalAdapter(List<ArtistCategory> artistList, OnArtistClickListener listener) {
