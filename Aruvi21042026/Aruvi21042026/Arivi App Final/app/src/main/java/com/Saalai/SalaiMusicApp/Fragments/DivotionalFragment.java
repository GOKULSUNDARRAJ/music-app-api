...
import com.Saalai.SalaiMusicApp.Adapters.ArtistDivotionalAdapter;
import com.Saalai.SalaiMusicApp.Adapters.PlaylistSectionArtistAdapter;
import com.Saalai.SalaiMusicApp.Adapters.PlaylistSectionDivotionalAdapter;
...
public class DivotionalFragment extends Fragment implements ArtistDivotionalAdapter.OnArtistClickListener, CustomRefreshLayout.OnRefreshListener {

    private static final String TAG = "ArtistFragment";

    private RecyclerView sectionsRecyclerView;
    private PlaylistSectionDivotionalAdapter sectionAdapter;
    ...
    private void setupRecyclerView() {
        ...
        sectionAdapter = new PlaylistSectionDivotionalAdapter(new ArrayList<PlaylistSection>(), this);
    }
    ...
    private void loadData() {
        ...
        Call<DevotionalResponse> call = apiService.getDevotionalData(authHeader);

        call.enqueue(new Callback<DevotionalResponse>() {
            @Override
            public void onResponse(Call<DevotionalResponse> call, Response<DevotionalResponse> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    DevotionalResponse artistResponse = response.body();
