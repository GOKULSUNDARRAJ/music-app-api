...
import com.Saalai.SalaiMusicApp.Adapters.YourAddToPlaylistSectionAdapter;
...
public class YourAddToPlaylistFragment extends Fragment implements
        YourAddToPlaylistSectionAdapter.OnCategoryClickListener,
        CustomRefreshLayout.OnRefreshListener {

    private static final String TAG = "YourAddToPlaylistFragment";

    private RecyclerView sectionsRecyclerView;
    private YourAddToPlaylistSectionAdapter sectionAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_your_addto_playlist, container, false);
    ...
    private void setupRecyclerView() {
        ...
        sectionAdapter = new YourAddToPlaylistSectionAdapter(new ArrayList<>(), this);
    }
    ...
    private void setupBroadcastReceivers() {
        ...
        // Receiver for playlist updates to refresh the list
    ...
    private void showEmptyState() {
        ...
        if (emptyText != null) {
            emptyText.setText("Your playlist is empty.\n\nTap the ➕ button on any playlist to add songs here.");
        }
    ...
    private void loadData() {
        ...
        if (accessToken == null || accessToken.isEmpty()) {
            ...
            showEmptyState();
            Toast.makeText(getContext(), "Please login to see your playlist", Toast.LENGTH_SHORT).show();
            return;
        }

        String authHeader = "Bearer " + accessToken;

        // Using /playlist/my endpoint to get user's playlist
        ...
        call.enqueue(new Callback<MyPlaylistResponse>() {
            ...
            public void onResponse(Call<MyPlaylistResponse> call, Response<MyPlaylistResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Log.d(TAG, "=== PLAYLIST DATA LOADED WITH " + (sections != null ? sections.size() : 0) + " SECTIONS ===");
                    ...
                    if (sections != null && !sections.isEmpty()) {
                        ...
                        Log.w(TAG, "No items in playlist");
                        showEmptyState();
                    }
                } else {
