...
public class YourAddToPlaylistSectionAdapter extends RecyclerView.Adapter<YourAddToPlaylistSectionAdapter.SectionViewHolder> {
    ...
    public YourAddToPlaylistSectionAdapter(List<PlaylistSection> sectionList, OnCategoryClickListener listener) {
    ...
    class SectionViewHolder extends RecyclerView.ViewHolder {
        ...
        private YourAddToPlaylistArtistAdapter artistAdapter;
        ...
        public void bind(PlaylistSection section) {
            ...
            artistAdapter = new YourAddToPlaylistArtistAdapter(
                    section.getArtists(),
