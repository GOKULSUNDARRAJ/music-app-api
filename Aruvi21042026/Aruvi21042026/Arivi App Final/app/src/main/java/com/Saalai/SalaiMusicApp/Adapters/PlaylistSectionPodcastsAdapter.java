...
public class PlaylistSectionPodcastsAdapter extends RecyclerView.Adapter<PlaylistSectionPodcastsAdapter.SectionViewHolder> {

    private List<PlaylistSection> sectionList;
    private ArtistPodcastsAdapter.OnArtistClickListener onArtistClickListener;
    ...
    public PlaylistSectionPodcastsAdapter(List<PlaylistSection> sectionList, ArtistPodcastsAdapter.OnArtistClickListener listener) {
    ...
    public SectionViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_section_prodcasts, parent, false);
    ...
    class SectionViewHolder extends RecyclerView.ViewHolder {
        ...
        private ArtistPodcastsAdapter artistAdapter;
        ...
        public void bind(PlaylistSection section) {
            ...
            artistAdapter = new ArtistPodcastsAdapter(section.getArtists(), onArtistClickListener);
