...
public class PlaylistSectionArtistAdapter extends RecyclerView.Adapter<PlaylistSectionArtistAdapter.SectionViewHolder> {

    private List<PlaylistSection> sectionList;
    private ArtistArtistAdapter.OnArtistClickListener onArtistClickListener;
    ...
    // Default span count for grid layouts
    private static final int GRID_SPAN_COUNT_2 = 2;
    private static final int GRID_SPAN_COUNT_3 = 3;

    public PlaylistSectionArtistAdapter(List<PlaylistSection> sectionList, ArtistArtistAdapter.OnArtistClickListener listener) {
    ...
    public SectionViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_section_artist, parent, false);
    ...
    class SectionViewHolder extends RecyclerView.ViewHolder {
        ...
        private ArtistArtistAdapter artistAdapter;
        ...
        public void bind(PlaylistSection section) {
            ...
            artistAdapter = new ArtistArtistAdapter(section.getArtists(), onArtistClickListener);
            ...
            switch (section.getLayoutType()) {
                ...
                case LAYOUT_GRID_3:
                    // Use 3 columns for 3-column grid layout
                    artistsRecyclerView.setLayoutManager(new GridLayoutManager(
                            itemView.getContext(),
                            GRID_SPAN_COUNT_3
                    ));
