...
public class YourFollowingPlaylistArtistAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public YourFollowingPlaylistArtistAdapter(List<ArtistCategory> artistList, OnArtistClickListener listener) {
    ...
    private boolean isCurrentPlaylistById(ArtistCategory artist) {
        ...
        Log.d("YourLikedPlaylistArtistAdapter", "Currently playing cat ID: " + currentCategoryId);
        Log.d("YourLikedPlaylistArtistAdapter", "Artist cat ID: " + artistCategoryId);
    ...
    // Type 5: Featured layout (Large image with overlay text)
        ...
        public void bind(ArtistCategory artist, boolean isCurrentPlaylist) {
            ...
            if (artist.getArtistImageUrl() != null && !artist.getArtistImageUrl().isEmpty()) {
                Glide.with(itemView.getContext())
                        ...
                        .apply(RequestOptions.bitmapTransform(new RoundedCorners(16)))
                        .placeholder(R.drawable.video_placholder)
                        .override(400, 400) // Larger size for featured layout
                        .into(artistImage);
            } else {
                artistImage.setImageResource(R.drawable.video_placholder);
            }
