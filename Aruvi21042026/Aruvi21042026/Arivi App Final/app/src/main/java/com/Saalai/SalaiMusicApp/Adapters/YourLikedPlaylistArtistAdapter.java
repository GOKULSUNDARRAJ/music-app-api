...
public class YourLikedPlaylistArtistAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public YourLikedPlaylistArtistAdapter(List<ArtistCategory> artistList, OnArtistClickListener listener) {
