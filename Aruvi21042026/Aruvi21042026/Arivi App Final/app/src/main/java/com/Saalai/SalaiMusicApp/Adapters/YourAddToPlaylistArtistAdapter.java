...
public class YourAddToPlaylistArtistAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public YourAddToPlaylistArtistAdapter(List<ArtistCategory> artistList, OnArtistClickListener listener) {
    ...
    private boolean isCurrentPlaylistById(ArtistCategory artist) {
        ...
        Log.d("YourAddToPlaylistArtistAdapter", "Currently playing cat ID: " + currentCategoryId);
        Log.d("YourAddToPlaylistArtistAdapter", "Artist cat ID: " + artistCategoryId);
    ...
    class Type6ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(ArtistCategory artist, boolean isCurrentPlaylist) {
            ...
            // Set play count if available (you can add this to ArtistCategory model)
