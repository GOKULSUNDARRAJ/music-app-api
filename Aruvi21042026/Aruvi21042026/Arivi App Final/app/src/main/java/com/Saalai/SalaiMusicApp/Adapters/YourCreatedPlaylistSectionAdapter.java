...
public class YourCreatedPlaylistSectionAdapter extends RecyclerView.Adapter<YourCreatedPlaylistSectionAdapter.SectionViewHolder> {
    ...
    public YourCreatedPlaylistSectionAdapter(List<PlaylistSection> sectionList, OnCategoryClickListener listener) {
    ...
    class SectionViewHolder extends RecyclerView.ViewHolder {
        ...
        private YourCreatedPlaylistArtistAdapter artistAdapter;
        ...
        public void bind(PlaylistSection section) {
            ...
            artistAdapter = new YourCreatedPlaylistArtistAdapter(
                    section.getArtists(),
