...
public class YourFollowingPlaylistSectionAdapter extends RecyclerView.Adapter<YourFollowingPlaylistSectionAdapter.SectionViewHolder> {
    ...
    public YourFollowingPlaylistSectionAdapter(List<PlaylistSection> sectionList, OnCategoryClickListener listener) {
    ...
    class SectionViewHolder extends RecyclerView.ViewHolder {
        ...
        private YourFollowingPlaylistArtistAdapter artistAdapter;
        ...
        public void bind(PlaylistSection section) {
            ...
            artistAdapter = new YourFollowingPlaylistArtistAdapter(
                    section.getArtists(),
