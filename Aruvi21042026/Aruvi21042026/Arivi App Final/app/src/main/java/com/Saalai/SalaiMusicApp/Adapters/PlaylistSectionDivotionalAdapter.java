...
public class PlaylistSectionDivotionalAdapter extends RecyclerView.Adapter<PlaylistSectionDivotionalAdapter.SectionViewHolder> {

    private List<PlaylistSection> sectionList;
    private ArtistDivotionalAdapter.OnArtistClickListener onArtistClickListener;
    ...
    public PlaylistSectionDivotionalAdapter(List<PlaylistSection> sectionList, ArtistDivotionalAdapter.OnArtistClickListener listener) {
    ...
    class SectionViewHolder extends RecyclerView.ViewHolder {
        ...
        private ArtistDivotionalAdapter artistAdapter;
        ...
        public void bind(PlaylistSection section) {
            ...
            artistAdapter = new ArtistDivotionalAdapter(section.getArtists(), onArtistClickListener);
