...
public class ArtistPodcastsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ArtistPodcastsAdapter(List<ArtistCategory> artistList, OnArtistClickListener listener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == 1) {
            View type1View = inflater.inflate(R.layout.item_artist_type1_pod, parent, false);
            return new Type1ViewHolder(type1View);
        } else if (viewType == 2) {
            View type2View = inflater.inflate(R.layout.item_artist_type2_pod, parent, false);
            return new Type2ViewHolder(type2View);
        } else if (viewType == 3) {
            View type3View = inflater.inflate(R.layout.item_artist_type3_pod, parent, false);
            return new Type3ViewHolder(type3View);
        } else {
            // Type 4
            View type4View = inflater.inflate(R.layout.item_artist_type4_pod, parent, false);
