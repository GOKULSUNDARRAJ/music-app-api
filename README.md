...
- rontend/ - React admin dashboard
- seed.js - Sample data seeding script

## Database Schema

- sections (id, sectionTitle, layoutType, spanCount)
- categories (id, categoryName, categoryImage, dapterType, sectionId)
- songs (id, udioName, udioUrl, imageUrl, categoryId)
...
- POST /api/user/checkRegister (Supports pplication/x-www-form-urlencoded)
